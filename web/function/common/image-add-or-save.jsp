...
<div class="right_content_pagePath">您现在所在的位置：添加或编辑图片信息</div>
<!--面包屑  end-->
...
<div class="form">
  <div class="table" style="display:">
    <h3 class="title"  id="001" > <b >填写图片信息</b>
    ...
    <img class="more_up form_action" src="${pageContext.request.contextPath}/resource/images/transparent.gif" alt="收起/展开" title="收起/展开" onClick="formAction(event)"> </h3>
      ...
      <form id="formID" action="${pageContext.request.contextPath}/image-manager/upsert-image.do" method="post" >
        <table class="list_table" border="0" cellspacing="0" cellpadding="0" width="100%" >
            ...
            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>图片名称</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="nameID" title="1到20个字符" class="input w200"  name="title" value="${edit.title}" required minlength="1" maxlength="20"   />
                </td>
            </tr>

            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>图片URL</td>
                <td class=" w245"  colspan="3">
            ...
            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>目标URL</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="targetURLID" title="1到20个字符" class="input w200"  name="targetURL" value="${edit.targetURL}" required minlength="1" maxlength="100"   />
                </td>
            </tr>

            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>时间</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="createTimeID" title="1到20个字符" class="input w200"  name="createTimeText" value="${edit.createTimeText}" onclick="WdatePicker()" required />
                </td>
            </tr>
