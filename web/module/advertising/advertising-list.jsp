...
<script type="text/javascript">
    ...
    {
        window.location.href = "${pageContext.request.contextPath}/advertising/add-advertising-page.do";
    }

    function editAdvertising(id)
    {

        window.location.href = "${pageContext.request.contextPath}/advertising/add-advertising-page.do?id="+id;
    }
...
<body>
            <!--面包屑-->
            <div class="right_content_pagePath">您现在所在的位置：广告管理</div>
            <!--面包屑  end-->
            ...
            <div class="btns" >
                <div id="search_form" class="form_content" >
                    <div class="table" style="">
                        ...
                        <form id="queryForm" action="${pageContext.request.contextPath}/advertising/list-advertising.do" method="get">
                            <table border="0" cellspacing="0" cellpadding="0" width="100%" >
                                ...
                                <tr class="">
                                    ...
                                    <td class="td_border_l td_title2 border_t">广告名称：</td>
                                    <td class="td_border_l border_t ">
                                        <input type="text" name="name" value="${queryCondition.name}" />
                                    </td>


                                    <td class="td_border_l td_title2 border_t">广告类型：</td>
                                    <td class="td_border_l border_t ">
                                        <s:checkboxes path="queryCondition.type" items="${advertisingTypeList}" itemValue="id" itemLabel="name" />
                                    </td>
                                ...
                                <tr class="" >
                                    <td class="td_border_l td_title2 border_t">项目：</td>
                                    <td class="td_border_l border_t ">
                                        <s:checkboxes path="queryCondition.projects" items="${projectList}" itemValue="id" itemLabel="name" />
                                    </td>

                                    <td class="td_border_l td_title2 border_t">平台：</td>
                                    <td class="td_border_l border_t ">
                                        <s:checkboxes path="queryCondition.platform" items="${platformEnumList}" itemValue="id" itemLabel="name" />
                                    </td>
                                </tr>
                ...
                <button  class="btn_save t-center" onclick="addAdvertising();">添加广告</button>
	                    ...
	                    <table id="content_t" border="0" cellspacing="0" cellpadding="0" class="grid_table">
                          ...
                          <tr  class="row">
                              <td >
                                    ...
                                    <a href="javascript:window.open('${ad.targetURL}')">
                                        <img width="100px" height="100px" src="${pageContext.request.contextPath}${ad.picPath}">
                                    </a>
                              ...
                              <td>
                                  <a onclick="editAdvertising('${ad.id}')">修改</a>
                                  <%--<a>删除</a>--%>
                              </td>
                          </tr>
                          </c:forEach>
