...
<script type="text/javascript">
    ...
    {
        window.location.href = "${pageContext.request.contextPath}/recommend/add-recommend-category-page.do";
    }

    function editRecommendCategory(id)
    {
        window.location.href = "${pageContext.request.contextPath}/recommend/add-recommend-category-page.do?id="+id;
    }

    function orderCategory(project)
    {

        window.location.href = "${pageContext.request.contextPath}/recommend/category-orderby.do?project="+project;
    }
...
<body>
            <!--面包屑-->
            <div class="right_content_pagePath">您现在所在的位置：精品分类</div>
            <!--面包屑  end-->
                ...
                <div class="grid_list">
                    <div class="grid_table_col margin-top_none">
	                    <table id="content_t" border="0" cellspacing="0" cellpadding="0" class="grid_table">
                          ...
                          <c:forEach items="${listCategory}" var="cateVar" >
                          <tr  class="row">

                              <td >
                                  id:${cateVar.id}<br/>
                                  分类名称:${cateVar.name}<br/>
                                  说明:${cateVar.desc}
                              </td>
                              <td>
                                  <a onclick="editRecommendCategory('${cateVar.id}')">修改</a>
                                  <a onclick="orderCategory('${cateVar.project}')">排序</a>
                              </td>
                          </tr>
                          </c:forEach>
