...
<script type="text/javascript">
    ...
    function changeApp(appID)
    {
        ...
        window.location.href = "${pageContext.request.contextPath}/app-analysis/count-frequency-for-oneapp.do?appID="+appID;

    }

    function changeCategory(categoryID)
    {
        window.location.href = "${pageContext.request.contextPath}/app-analysis/count-frequency-for-oneapp.do?categoryID="+categoryID;
    }
...
<body>
            <!--面包屑-->
            <div class="right_content_pagePath">您现在所在的位置：使用频率</div>
            <!--面包屑  end-->
     ...
     <div id="query_result" class="form_content"   >
	  ...
	  <table id="content_t" border="0" cellspacing="0" cellpadding="0" class="grid_table">
                          ...
                          <tr  class="row">
                              ...
                              <td>
                                  ${frequencyFor10To19["allUserCount"]}
                              </td>
                          </tr>
