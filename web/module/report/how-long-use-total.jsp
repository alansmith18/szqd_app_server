...
<body>
            <!--面包屑-->
            <div class="right_content_pagePath">您现在所在的位置：类别总的使用时长</div>
            <!--面包屑  end-->
           ...
           <%--<div id="search_form" class="form_content" >--%>
            ...
            <div class="btns" >
                ...
                <%--<button  class="btn_save t-center" onclick="addUser();">添加用户</button>--%>
                    <a href="${pageContext.request.contextPath}/app-analysis/count-time-seage-for-oneapp.do">切换至时长比对</a>
                    ...
                    <div class="grid_table_col margin-top_none">
                            <table id="content_t" border="0" cellspacing="0" cellpadding="0" class="grid_table">
                              ...
                              <tr  class="row">
                                ...
                                <td>${t["categoryUseTimeTotalCount"]/1000/60/60}</td>
