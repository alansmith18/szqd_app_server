...
<script type="text/javascript">
    ...
    function changeApp(appID)
    {
        ...
        window.location.href = "${pageContext.request.contextPath}/app-analysis/count-time-seage-for-oneapp.do?appID="+appID;

    }

    function changeCategory(categoryID)
    {
        window.location.href = "${pageContext.request.contextPath}/app-analysis/count-time-seage-for-oneapp.do?categoryID="+categoryID;
    }
...
<body>
            <!--面包屑-->
            <div class="right_content_pagePath">您现在所在的位置：使用时长</div>
            <!--面包屑  end-->
          ...
          <td  colspan="4" class="tab2s">
           <%--<div id="search_form" class="form_content" >--%>
            ...
            <div class="btns" >
                ...
                <a href="${pageContext.request.contextPath}/app-analysis/count-total-time-seage-for-category.do">切换至类别比对</a>
    ...
    <!--1-->
     <div id="query_result" class="form_content"   >
	  ...
	  <table id="content_t" border="0" cellspacing="0" cellpadding="0" class="grid_table">
                          ...
                          <c:forEach items="${timeUseageListForOneApp}" var="t" >
                          <tr  class="row">

                            <td>${t["categoryName"].name}</td>
                            <td>${t["useCategoryCount"]}</td>
