...
<div class="right_content_pagePath">您现在所在的位置：添加皮肤</div>
<!--面包屑  end-->
...
<div class="form">
  <div class="table" style="display:">
    <h3 class="title"  id="001" > <b >填写皮肤信息</b>
    ...
    <img class="more_up form_action" src="${pageContext.request.contextPath}/resource/images/transparent.gif" alt="收起/展开" title="收起/展开" onClick="formAction(event)"> </h3>
      ...
      <form id="formSaveUserID" action="${pageContext.request.contextPath}/skin/add-skin.do" method="post" >
        <table class="list_table" border="0" cellspacing="0" cellpadding="0" width="100%" >
            ...
            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>说明</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="descID" title="2到20个字符" class="input w200"  name="desc" value="${edit.desc}" required minlength="2" maxlength="20"   />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class=" w245"  colspan="3">
                    ...
                    <s:checkboxes path="edit.platforms" items="${platformList}" itemValue="id" itemLabel="name" />
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class=" w245"  colspan="3">
                    ...
                    <s:select path="edit.status" >
                        <s:options items="${projectStatusList}" itemLabel="name" itemValue="id"/>
                    </s:select>
                </td>
            </tr>
            ...
            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>编号</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="numberID" title="请填写数字" class="input w200"  name="number" value="${edit.number}" required digits="true" minlength="2" maxlength="10"   />
                </td>
            </tr>


            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>字体颜色</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="fontColorID" title="1到10个字符" class="input w200"  name="fontColor" value="${edit.fontColor}" required  minlength="1" maxlength="10"   />
                </td>
            </tr>

            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>高亮颜色</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="brightnessColorID" title="1到10个字符" class="input w200"  name="brightnessColor" value="${edit.brightnessColor}" required  minlength="1" maxlength="10"   />
                </td>
            </tr>


            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>推荐</td>
                <td class=" w245"  colspan="3">
                    <s:select path="edit.isRecommend">
                        <s:options items="${isRecommendList}" itemLabel="name" itemValue="id" />
                    </s:select>
                </td>
            </tr>
            ...
            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>皮肤包:</td>
                <td class=" w245"  colspan="3">

                    <input type="file" id="skinPackagePathFileID" />
                    <input type="hidden" id="skinPackagePathID" name="skinPackagePath" value="${edit.skinPackagePath}"/>

                    <br/>
                    <div id="skinPackagePathDIVID" >
                        <c:if test="${!empty edit.skinPackagePath}">
                            <a href="javascript:window.open('${pageContext.request.contextPath}${edit.skinPackagePath}')">${edit.skinPackagePath}</a>
                        </c:if>
                    </div>
