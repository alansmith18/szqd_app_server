...
<div class="right_content_pagePath">您现在所在的位置：添加或编辑开关信息</div>
<!--面包屑  end-->
...
<div class="form">
  <div class="table" style="display:">
    <h3 class="title"  id="001" > <b >填写开关信息</b>
    ...
    <img class="more_up form_action" src="${pageContext.request.contextPath}/resource/images/transparent.gif" alt="收起/展开" title="收起/展开" onClick="formAction(event)"> </h3>
      ...
      <form id="formID" action="${pageContext.request.contextPath}/switch/save-switch.do" method="post" >
        <table class="list_table" border="0" cellspacing="0" cellpadding="0" width="100%" >
            ...
            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>开关名称</td>
            ...
            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>开关</td>
                <td class=" w245"  colspan="3">
                    <s:select path="edit.status">
                        <s:option value="0" label="关"/>
                        <s:option value="1" label="开"/>
                    </s:select>
                </td>
            </tr>
