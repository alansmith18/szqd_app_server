...
<div class="right_content_pagePath">您现在所在的位置：用户注册</div>
<!--面包屑  end-->
      ...
      <form id="formSaveUserID" action="${pageContext.request.contextPath}/popularize/save-user.do" method="post">
        <table class="list_table" border="0" cellspacing="0" cellpadding="0" width="100%" >
            ...
            <tr id="platformNameTrID" style="display: none;" >
                <td class="td_title_left w130"><span class="red">&nbsp;</span>平台或公司名称</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="platformNameID" title="名称为2到50个字符" class="input w200"  name="platformName" required minlength="2" maxlength="50"   >
                </td>
            </tr>

            <tr id="scaleTrID" style="display: none;">
                <td class="td_title_left w130"><span class="red">&nbsp;</span>联系方式</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="contactInfoID" disabled title="联系方式必填" class="input w200"  name="contactInfo" minlength="1" maxlength="50" required   >
                </td>
            </tr>
