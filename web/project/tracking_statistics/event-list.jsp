...
<script type="text/javascript">
    ...
    function add()
    {
        window.location.href = "${pageContext.request.contextPath}/tracking-statistics/upsert-event-page.do";
    }

    function edit(id)
    {
        window.location.href = "${pageContext.request.contextPath}/tracking-statistics/upsert-event-page.do?id="+id;
    }
            ...
            <div class="btns" >
                <div id="search_form" class="form_content" >
                    <div class="table" style="">
                        ...
                        <form id="queryForm" action="${pageContext.request.contextPath}/tracking-statistics/list-event.do" method="get">
                            <table border="0" cellspacing="0" cellpadding="0" width="100%" >
                                ...
                                <tr class="">
                                    ...
                                    <td class="td_border_l border_t ">
                                        <s:select path="queryCondition.projectID">
                                            <s:option value="" label="选择项目"/>
                                    ...
                                    <td class="td_border_l border_t ">
                                        <input type="text" name="nameRegex" value="${queryCondition.nameRegex}" />
                                    </td>
                ...
                <button  class="btn_save t-center" onclick="window.open('${pageContext.request.contextPath}/tracking-statistics/report-number-of-trigger-event.do')">打开报表</button>
            </div>
          </td>
                    ...
                    <div class="grid_table_col margin-top_none">
	                    <table id="content_t" border="0" cellspacing="0" cellpadding="0" class="grid_table">
                            ...
                            <tr class="tr_bg02" style=" border-top:none;"  >
                                <th class=" bold" >事件id</th>
                                <th class=" bold" >事件名称</th>
                                <th class=" bold" style="width: 140px">跳转URL</th>
                                <th class=" bold" >操作</th>
                            </tr>
