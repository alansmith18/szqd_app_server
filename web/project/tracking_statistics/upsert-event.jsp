...
<div class="right_content_pagePath">您现在所在的位置：添加或编辑事件</div>
<!--面包屑  end-->
...
<div class="form">
  <div class="table" style="display:">
    <h3 class="title"  id="001" > <b >填写事件</b>
    ...
    <img class="more_up form_action" src="${pageContext.request.contextPath}/resource/images/transparent.gif" alt="收起/展开" title="收起/展开" onClick="formAction(event)"> </h3>
      ...
      <form id="formID" action="${pageContext.request.contextPath}/tracking-statistics/upsert-event.do" method="post" >
        <table class="list_table" border="0" cellspacing="0" cellpadding="0" width="100%" >
            ...
            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>事件名称</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="nameID" title="1到20个字符" class="input w200"  name="name" value="${edit.name}" required minlength="1" maxlength="20"   />
                </td>
            </tr>

            <tr>
                <td class="td_title_left w130"><span class="red">&nbsp;</span>跳转URL</td>
                <td class=" w245"  colspan="3">
                    <input type="text" id="urlID" title="1到20个字符" class="input w200"  name="forwardURL" value="${edit.forwardURL}" required minlength="1" maxlength="100"   />
                </td>
            </tr>
